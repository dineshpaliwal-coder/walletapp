...
import 'package:djtechfinwallet/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<DjtechfinwalletFirebaseUser> userStream;
  DjtechfinwalletFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = djtechfinwalletFirebaseUserStream()
